...
public class ExchangeTopicConfiguration implements ConsumeConfiguration {
    private final String exchangeName;

    public ExchangeTopicConfiguration() {
        this("event");
    }

    public ExchangeTopicConfiguration(String exchangeName) {
