package fr.recia.replayer_kafka_poc.configuration;

import com.fasterxml.jackson.annotation.JsonTypeInfo;


import fr.recia.replayer_kafka_poc.service.RedisReplayerExpirationListener;
...
@Configuration
public class RedisReplayedConfig {
    @Bean
    ...
    @Bean
    public MessageListenerAdapter listenerAdapter(RedisReplayerExpirationListener listener) {
